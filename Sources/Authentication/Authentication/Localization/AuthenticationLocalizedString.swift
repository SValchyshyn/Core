//
//  AuthenticationLocalizedString.swift
//  Authentication
//
//  Created by Ihor Zabrotskyi on 18.11.2021.
...
public func AuthenticationLocalizedString(_ key: String, comment: String = "", _ args: CVarArg...) -> String {
	ModuleLocalizedString(key, comment: comment, args, tableName: "Authentication", module: .module)
}
